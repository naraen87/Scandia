...
E:\Jenkins_Software\PortQry.exe -n %servername% -e 8001 -q
...
:startstate2
ping -n 121 127.0.0.1>nul
E:\Jenkins_Software\PortQry.exe -n %servername% -e 8005 -q
...
:startstate3
ping -n 121 127.0.0.1>nul
E:\Jenkins_Software\PortQry.exe -n %servername% -e 8003 -q
